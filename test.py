...
def check_time():
    ...
    def send_msg():
        ...
        class_0 = now.hour == 8 and now.minute == 40

        class_1 = now.hour == 9 and now.minute == 5
        ...
        class_4 = now.hour == 12 and now.minute == 45

        class_5 = now.hour == 13 and now.minute == 40
        #     send_msg()
