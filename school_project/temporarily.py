...
mon = [start, sciencejgm, koreanshj, musickgy]
tus = [start, societygyh, englichldh, sciencejyn]
wed = [start, artksj, musickgy, sciencejgm]
thu = [start, koreanshj, mathymg, societypsm]
fri = [historylgj, korean2gjg]
