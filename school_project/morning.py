...
mon = [korean2gjg, exerciselhc, englichldh]
# tus = [societygyh, exerciselhc, korean2gjg]
tus = [sciencejgm, artcs, mathymg]
wed = [futurelsj, sciencejgm, korean2gjg] #artksj
thu = [mathymg, koreanshj, historymcb]
fri = [englishchg, societygyh, sciencejyn]
sat = []
sun = []
...
def check_time():
    ...
    def send_msg():
        ...
        pyautogui.moveTo(2480, 1720, 1)
        pyautogui.doubleClick()
        time.sleep(6)

        pyautogui.moveTo(2100, -70, 1)
        pyautogui.doubleClick()
        time.sleep(1.5)
        ...
        threading.Timer(3900, send_msg).start()
